<?php /* Smarty version Smarty-3.0.8, created on 2017-11-29 06:41:45
         compiled from "/data/www/cloudbooks.top/tpl/search.htm" */ ?>
<?php /*%%SmartyHeaderCode:7091085245a1e56a995b399-47808480%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '59d41f4719b5bb11e52a5f82ada86d36f0f476c4' => 
    array (
      0 => '/data/www/cloudbooks.top/tpl/search.htm',
      1 => 1511937669,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7091085245a1e56a995b399-47808480',
  'function' => 
  array (
  ),
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title id="title"><?php echo $_smarty_tpl->getVariable('kw')->value;?>
-吾爱磁力搜索|bt搜索</title>

    <meta name="keywords" content="<?php echo $_smarty_tpl->getVariable('kw')->value;?>
 磁力搜索|bt搜索|云书搜索">

    <meta name="description" content="<?php echo $_smarty_tpl->getVariable('kw')->value;?>
 专业的磁力搜索引擎|bt搜索 爱磁力搜索 吾爱磁力搜索 爬虫搜索">
...
<div class="hot_search"><div class="col-md-5  hot_form">
     ...
     <button class="btn btn-primary"  onclick="location.href='/bind/search/kw/'+$('#serach').val()+'.html';return false;">
...
<!--<a target="_blank" href="http://1765610.iz45.com">
<img src='http://1755446.iz45.com/banner/300x300.gif'  id='ad_truelove'  width="300" height="300">
</a>	 -->
...
<div id="footer">
 ...
 <script>
 //$("#title").text("第"+page+"页，"+kw)

//$('#spanViewPage').text("当前第"+page+"页 ，");
function addPage(tpage,page,kw){

var maxpage =parseInt(tpage/20);
...
//if(privous<1){privous=1;}

$('#pageIndex').html('<li><a  href="/bind/search/kw/'+kw+'/page/'+privous+'.html" >上一页</a></li>');

for(var i=0;i<8;i++){
	
	$('#pageIndex').html( $('#pageIndex').html()+'<li><a href="/bind/search/kw/'+kw+'/page/'+(pp+i)+'.html">'+(pp+i)+'</a></li>');
	if(pp+i>maxpage+1){
		break;
	}
}

$('#pageIndex').html($('#pageIndex').html()+'<li><a href="/bind/search/kw/'+kw+'/page/'+next+'.html" >下一页</a></li>');
...
;
//alert(jsondata);
if(jsondata.illegal==1){
$('#id_col8_content').html("<img style='width:390px;'src='/static/img/illegal.png'>");
...
$('#id_col8_content').html("<img id='load' style='width:390px;' src='/static/img/nodata.png'>");
	...
	//var gettpl = document.getElementById('media-list');
	//var html = template('tpl-item', jsondata); 
	//gettpl.innerHTML=html;
	
	addPage(jsondata.total_found,jsondata.cpage,jsondata.kw);
}
